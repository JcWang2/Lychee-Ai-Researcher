#!/usr/bin/env bash
# monitor_v2_v256_live.sh - v2.5.6 live monitor (declarative method architecture) (24h-mle / smoke / lite / any TASK_LIST)
...
# Usage:
#   bash monitor_v2_v256_live.sh                 # auto-pick newest run
#   bash monitor_v2_v256_live.sh <STAMP>         # pin a specific run
#   FOLLOW_TASK=hubmap-kidney-segmentation bash monitor_v2_v256_live.sh <STAMP>
#   REFRESH_SECS=3 bash monitor_v2_v256_live.sh  # faster refresh
#   STATE_ROOT=/mnt/data/v2_state_lite bash monitor_v2_v256_live.sh   # lite trio
set +e
...
show_header() {
  ...
  echo "  Follow one task: FOLLOW_TASK=<task> bash monitor_v2_v256_live.sh $STAMP"
}
